...
function maggie_lite_setup()
{
        ...
        */
        ...
        add_image_size('maggie-lite-block-big-thumb', 580, 493, true); //Big thumb for homepage block
        ...
        add_image_size('maggie-lite-blockthree-big-thumb', 400, 255, true); //Big thumb for homepage 3rd block
        add_image_size('maggie-lite-blockthree-small-thumb', 100, 100, true); //Small thumb for homepage 3rd block
        add_image_size('maggie-lite-blockfour-thumb', 400, 200, true); //Small thumb for homepage block
